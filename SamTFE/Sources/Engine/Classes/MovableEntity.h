...
#line 332 "C:/SeriousSam/SeriousSamClassic-DX9-MY/SamTFE/Sources.VS2019.BL.TFE.FONT.HUD/Engine/Classes/MovableEntity.es"
...
#line 404 "C:/SeriousSam/SeriousSamClassic-DX9-MY/SamTFE/Sources.VS2019.BL.TFE.FONT.HUD/Engine/Classes/MovableEntity.es"
...
#line 655 "C:/SeriousSam/SeriousSamClassic-DX9-MY/SamTFE/Sources.VS2019.BL.TFE.FONT.HUD/Engine/Classes/MovableEntity.es"
CMovableEntity * penLauncher);
   void LaunchAsFreeProjectile(const FLOAT3D & vImpulseSpeedRelative,
#line 663 "C:/SeriousSam/SeriousSamClassic-DX9-MY/SamTFE/Sources.VS2019.BL.TFE.FONT.HUD/Engine/Classes/MovableEntity.es"
CMovableEntity * penLauncher);
...
#line 693 "C:/SeriousSam/SeriousSamClassic-DX9-MY/SamTFE/Sources.VS2019.BL.TFE.FONT.HUD/Engine/Classes/MovableEntity.es"
...
#line 794 "C:/SeriousSam/SeriousSamClassic-DX9-MY/SamTFE/Sources.VS2019.BL.TFE.FONT.HUD/Engine/Classes/MovableEntity.es"
CEntity * MiscDamageInflictor(void);
   
#line 811 "C:/SeriousSam/SeriousSamClassic-DX9-MY/SamTFE/Sources.VS2019.BL.TFE.FONT.HUD/Engine/Classes/MovableEntity.es"
void UpdateOneSectorForce(CBrushSector & bsc,FLOAT fRatio);
   
#line 860 "C:/SeriousSam/SeriousSamClassic-DX9-MY/SamTFE/Sources.VS2019.BL.TFE.FONT.HUD/Engine/Classes/MovableEntity.es"
void TestFields(INDEX & iUpContent,INDEX & iDnContent,FLOAT & fImmersionFactor);
   
#line 1003 "C:/SeriousSam/SeriousSamClassic-DX9-MY/SamTFE/Sources.VS2019.BL.TFE.FONT.HUD/Engine/Classes/MovableEntity.es"
void TestBreathing(CContentType & ctUp);
   
#line 1039 "C:/SeriousSam/SeriousSamClassic-DX9-MY/SamTFE/Sources.VS2019.BL.TFE.FONT.HUD/Engine/Classes/MovableEntity.es"
void TestContentDamage(CContentType & ctDn,FLOAT fImmersion);
   
#line 1072 "C:/SeriousSam/SeriousSamClassic-DX9-MY/SamTFE/Sources.VS2019.BL.TFE.FONT.HUD/Engine/Classes/MovableEntity.es"
void TestSurfaceDamage(CSurfaceType & stDn);
   
#line 1098 "C:/SeriousSam/SeriousSamClassic-DX9-MY/SamTFE/Sources.VS2019.BL.TFE.FONT.HUD/Engine/Classes/MovableEntity.es"
void SendTouchEvent(const CClipMove & cmMove);
   
#line 1113 "C:/SeriousSam/SeriousSamClassic-DX9-MY/SamTFE/Sources.VS2019.BL.TFE.FONT.HUD/Engine/Classes/MovableEntity.es"
void SendBlockEvent(CClipMove & cmMove);
   
#line 1121 "C:/SeriousSam/SeriousSamClassic-DX9-MY/SamTFE/Sources.VS2019.BL.TFE.FONT.HUD/Engine/Classes/MovableEntity.es"
BOOL IsStandingOnPolygon(CBrushPolygon * pbpo);
   
#line 1184 "C:/SeriousSam/SeriousSamClassic-DX9-MY/SamTFE/Sources.VS2019.BL.TFE.FONT.HUD/Engine/Classes/MovableEntity.es"
...
#line 1274 "C:/SeriousSam/SeriousSamClassic-DX9-MY/SamTFE/Sources.VS2019.BL.TFE.FONT.HUD/Engine/Classes/MovableEntity.es"
BOOL IsSomeNearPolygonBelowPoint(const FLOAT3D & vPoint,FLOAT fMaxDist);
   
#line 1281 "C:/SeriousSam/SeriousSamClassic-DX9-MY/SamTFE/Sources.VS2019.BL.TFE.FONT.HUD/Engine/Classes/MovableEntity.es"
BOOL IsSomeSectorPolygonBelowPoint(CBrushSector * pbsc,const FLOAT3D & vPoint,FLOAT fMaxDist);
   
#line 1297 "C:/SeriousSam/SeriousSamClassic-DX9-MY/SamTFE/Sources.VS2019.BL.TFE.FONT.HUD/Engine/Classes/MovableEntity.es"
BOOL WouldFallInNextPosition(void);
   
#line 1407 "C:/SeriousSam/SeriousSamClassic-DX9-MY/SamTFE/Sources.VS2019.BL.TFE.FONT.HUD/Engine/Classes/MovableEntity.es"
void ClearNextPosition(void);
   
#line 1413 "C:/SeriousSam/SeriousSamClassic-DX9-MY/SamTFE/Sources.VS2019.BL.TFE.FONT.HUD/Engine/Classes/MovableEntity.es"
void SetPlacementFromNextPosition(void);
   
#line 1440 "C:/SeriousSam/SeriousSamClassic-DX9-MY/SamTFE/Sources.VS2019.BL.TFE.FONT.HUD/Engine/Classes/MovableEntity.es"
BOOL TryToGoUpstairs(const FLOAT3D & vTranslationAbsolute,const CSurfaceType & stHit,
#line 1441 "C:/SeriousSam/SeriousSamClassic-DX9-MY/SamTFE/Sources.VS2019.BL.TFE.FONT.HUD/Engine/Classes/MovableEntity.es"
BOOL bHitStairsOrg);
   
#line 1594 "C:/SeriousSam/SeriousSamClassic-DX9-MY/SamTFE/Sources.VS2019.BL.TFE.FONT.HUD/Engine/Classes/MovableEntity.es"
BOOL TryToMove(CMovableEntity * penPusher,BOOL bTranslate,BOOL bRotate);
   void ClearMovingTemp(void);
   void PreMoving(void);
   
#line 2025 "C:/SeriousSam/SeriousSamClassic-DX9-MY/SamTFE/Sources.VS2019.BL.TFE.FONT.HUD/Engine/Classes/MovableEntity.es"
void PreMovingNew(void);
   
#line 2441 "C:/SeriousSam/SeriousSamClassic-DX9-MY/SamTFE/Sources.VS2019.BL.TFE.FONT.HUD/Engine/Classes/MovableEntity.es"
void PreMovingOld(void);
   void DoMoving(void);
   void PostMoving(void);
   void CacheNearPolygons(void);
   
#line 3104 "C:/SeriousSam/SeriousSamClassic-DX9-MY/SamTFE/Sources.VS2019.BL.TFE.FONT.HUD/Engine/Classes/MovableEntity.es"
SLONG GetUsedMemory(void);
#define  STATE_CMovableEntity_Dummy 0x00010000
  BOOL 
#line 3118 "C:/SeriousSam/SeriousSamClassic-DX9-MY/SamTFE/Sources.VS2019.BL.TFE.FONT.HUD/Engine/Classes/MovableEntity.es"
