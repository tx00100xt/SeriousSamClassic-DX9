...
extern void ReloadTextures(void)
{
  ...
  CPrintF(TRANS("loop thru texture stock without clear.\n"));
...
#ifdef SE1_D3D
ULONG64 CGfxLibrary::SaveVertexShader(LPDIRECT3DVERTEXSHADER9 vs, LPDIRECT3DVERTEXDECLARATION9 vDec, ULONG64 ulStreamFlags)
{
	curVS++;
	/*
	...
	mapVS.insert(std::pair<ULONG64, stVertexShaderInfo*>(curVS, pInfo));
	*/
...
stVertexShaderInfo* CGfxLibrary::GetVertexShader(ULONG64 ulHandle)
{
...
void CGfxLibrary::DeleteVertexShader(ULONG64 ulHandle)
{
