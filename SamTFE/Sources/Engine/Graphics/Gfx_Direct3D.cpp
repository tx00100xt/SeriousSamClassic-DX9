...
static ULONG64 _dwCurrentVS = NONE;
...
BOOL CGfxLibrary::InitDriver_D3D(void)
{
  ...
  gl_hiDriver = (CDynamicLoader *)LoadLibraryA( "D3D9.DLL");
  if( gl_hiDriver==NONE) {
...
#if (defined __MSVC_INLINE__) && (defined  PLATFORM_32BIT)  && (defined  ASMOPT)
