...
private:
  ...
  std::unordered_map<ULONG64, stVertexShaderInfo*> mapVS;
#endif
...
// ### DX9
#ifdef SE1_D3D
  ULONG64 SaveVertexShader(LPDIRECT3DVERTEXSHADER9 vs, LPDIRECT3DVERTEXDECLARATION9 vDec, ULONG64 ulStreamFlags);
  stVertexShaderInfo* GetVertexShader(ULONG64 ulHandle);
  ...
  void DeleteVertexShader(ULONG64 ulHandle);
#endif // SE1_D3D
