...
__extern void (*gfxGenerateTexture)( ULONG64 &ulTexObject) = NULL;
__extern void (*gfxDeleteTexture)( ULONG64 &ulTexObject) = NULL;
...
__extern void gfxSetTexture( ULONG64 &ulTexObject, CTexParams &tpLocal)
{
...
__extern SLONG gfxGetTextureSize( ULONG64 ulTexObject, BOOL bHasMipmaps/*=TRUE*/)
{
...
__extern INDEX gfxGetTexturePixRatio( ULONG64 ulTextureObject)
{
  // determine API
  const GfxAPIType eAPI = _pGfx->gl_eCurrentAPI;
  ASSERT( GfxValidApi(eAPI) );
...
__extern ULONG64 _ulPatternTexture = NONE;
__extern ULONG64 _ulLastUploadedPattern = 0;
...
static void none_GenDelTexture( ULONG64 &ulTexObject) { NOTHING; };
