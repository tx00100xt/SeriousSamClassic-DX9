...
extern void (*gfxGenerateTexture)( ULONG64 &ulTexObject);
// unbind texture from API
extern void (*gfxDeleteTexture)( ULONG64 &ulTexObject);


// set texture as current
//  - ulTexture = bind number for OGL, or *LPDIRECT3DTEXTURE8 for D3D (pointer to pointer!)
extern void gfxSetTexture( ULONG64 &ulTexObject, CTexParams &tpLocal);
...
extern SLONG gfxGetTextureSize( ULONG64 ulTexObject, BOOL bHasMipmaps=TRUE);

// returns bytes/pixels ratio for uploaded texture or texture format
extern INDEX gfxGetTexturePixRatio( ULONG64 ulTextureObject);
